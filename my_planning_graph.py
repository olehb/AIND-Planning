...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return (set(node_a1.action.effect_add) & set(node_a2.action.effect_rem)
                or set(node_a2.action.effect_add) & set(node_a1.action.effect_rem))
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return (set(node_a1.action.effect_add) & set(node_a2.action.precond_neg)
                or set(node_a1.action.effect_rem) & set(node_a2.action.precond_pos)
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        :return: bool
        """
        return all([parent1.is_mutex(parent2)
